...
cdef extern from "pprgrow_max_mod.h":
	void init(long *data, long n_data, long *indices, long n_indices, long *indptr, long n_indptr, long *seed, long n_seed,
		long *community, double *maxmod, double alpha, double curexpand)

# create the wrapper code, with numpy type annotations
def pprgrow_max_mod_func(np.ndarray[long, ndim=1, mode="c"] data not None, long n_data,
	...
	double maxmod, double alpha, double curexpand):
